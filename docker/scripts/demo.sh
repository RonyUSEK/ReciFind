...
echo "   Admin: admin@recifind.com / password123"
echo ""
...
echo ""
echo "The database is automatically initialized with:"
echo "   • 9 demo users (3 users, 3 chefs, 3 admins)"
echo "   • 12 sample recipes (Italian, Asian, American cuisine)"
echo "   • 40+ cooking ingredients"
echo "   • Recipe collections (Saved) and recipe-only reports"
echo ""
